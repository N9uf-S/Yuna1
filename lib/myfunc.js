...
exports.tanggal = (numer) => {
    const myMonths = ["Janvier", "Février", "Mars", "Avril", "Mai", "Juin", "Juillet", "Août", "Septembre", "Octobre", "Novembre", "Décembre"];
    const myDays = ['Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'vendredi', 'Samedi', 'Dimanche'];
    ...
    const d = new Date();
    const locale = 'id';
    const gmt = new Date(0).getTime() - new Date('1 Janvier 1960').getTime();
   
    return `${thisDay}, ${day} - ${myMonths} - ${year}`;
}
